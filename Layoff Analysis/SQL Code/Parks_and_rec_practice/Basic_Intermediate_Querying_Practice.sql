-- Practicing various SQL Querying elements (SELECT, WHERE and ALIASING)
SELECT * 
...
-- Practicing LIKE with special characters % (many characters) and _ (single wildcard)
SELECT * 
FROM employee_demographics
...
-- Practicing More complex UNIONS
