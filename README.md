...
- Contents
    - 
    - Data: Contains the csv files used to import data into MYSQL database via Import Wizard
    - SQL Code: Main Folder for all code used in this project and SQL files including EDA and data cleaning 
        - Parks_and_rec_practice: A subfolder with some code used to work on syntax and querying prior to project execution
